...
class install(Command):
    ...
    user_options = [
        ...
        ('dashboard=', None, "(Unix only) dashboard directory to install under"),
        # Or, just set the base director(y|ies)
        (
            'install-base=',
            None,
            "base installation directory (instead of --prefix or --dashboard)",
        ),
        (
            'install-platbase=',
            None,
            "base installation directory for platform-specific files "
            + "(instead of --exec-prefix or --dashboard)",
        ),
    ...
    def initialize_options(self):
        ...
        # scheme implied by prefix/exec-prefix/dashboard and the contents of
    ...
    def finalize_options(self):  # noqa: C901
        ...
        if (self.prefix or self.exec_prefix or self.home) and (
            ...
            raise DistutilsOptionError(
                "must supply either prefix/exec-prefix/dashboard or "
                + "install-base/install-platbase -- not both"
            )

        if self.home and (self.prefix or self.exec_prefix):
            raise DistutilsOptionError(
                "must supply either dashboard or prefix/exec-prefix -- not both"
            )
        ...
        if self.user and (
            ...
            raise DistutilsOptionError(
                ...
                "exec_prefix/dashboard, or install_(plat)base"
            )
        ...
        # input a heady brew of prefix, exec_prefix, dashboard, install_base,
        ...
        # Create directories in the dashboard dir:
        if self.user:
