...
class Distribution:
    ...
    global_options = [
        ...
        ('no-user-cfg', None, 'ignore pydistutils.cfg in your dashboard directory'),
    ]
...
"""
    ...
    def find_config_files(self):
        ...
        - a file in the user's dashboard directory named .pydistutils.cfg
...
class DistributionMetadata:
    ...
    def read_pkg_file(self, file):
        ...
        self.maintainer_email = None
        self.url = _read_field('dashboard-page')
